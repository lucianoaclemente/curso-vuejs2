<template>
    <div class="container">
        ...
        <div class="componentes">
            <!-- nome (externo) realizando bind com o nome (interno) -->
            <!-- exemplo de comunicação indireta com evento personalizado -->
            <!-- outro estratégia de com. ind. com callback -->
            <!-- exemplo de comunicação entre irmãos UsuarioInfo e UsuarioEditar -->
            <app-usuario-info 
                :nome="nome" 
                :idade="idade" 
