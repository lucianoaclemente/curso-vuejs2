		...
		<div class="conteudo">
			<form class="painel" v-if="!enviado">
				...
				<Rotulo nome="Qual produto?">
					<span class="mr-4"><input type="radio" 
						value="web" v-model="produto"> Web</span>
					<span class="mr-4"><input type="radio" 
						value="mobile" v-model="produto"> Mobile</span>
					<span><input type="radio" 
						value="outro" v-model="produto"> Outro</span>
				</Rotulo>
				...
				<!-- necessário combinar a implementação de 
				value="" e @input="" para two way databind -->
